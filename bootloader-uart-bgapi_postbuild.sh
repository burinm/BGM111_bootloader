...
echo " "
"${COMMANDER}" convert "/home/burin/SimplicityStudio_v4/developer/sdks/gecko_sdk_suite/v2.4/platform/bootloader/build/first_stage/gcc/first_stage_btl_efx32xg11.s37" "${FILENAME}.s37" -o "${FILENAME}-combined.s37"
